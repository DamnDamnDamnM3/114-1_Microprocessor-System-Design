/*
 * ================================================================
 * Lab 5.1 - Seven_Segment.c: 七段顯示器控制函數庫
 * 功能：提供七段顯示器的初始化、顯示和關閉功能
 * 硬體：NUC100系列微控制器
...
// 七段顯示器緩衝區陣列，包含所有數字模式
uint8_t SEG_BUF[16]={SEG_N0, SEG_N1, SEG_N2, SEG_N3, SEG_N4, SEG_N5,
 ...
 * ================================================================
 * 七段顯示器顯示函數
 * 功能：在指定的七段顯示器位置顯示指定數字
 * 參數：no - 顯示器位置(0-3), number - 要顯示的數字(0-15)
 * ================================================================
 */
